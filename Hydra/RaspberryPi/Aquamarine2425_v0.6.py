...
window = pygame.display.set_mode((1440,1080),flags=0,depth=24)
...
def main():
    ...
    while running:
        ...
        theta = math.atan2(apply_deadzone(joyY, 0.25),
                           apply_deadzone(joyX, 0.25))
        power = math.hypot(apply_deadzone(joyX, 0.25),
                           apply_deadzone(joyY, 0.25))
