...
def main(roll, pitch, yaw, joyX, joyY, twist, slider, leftFront, rightFront, leftBack, rightBack):

    window.fill(SKY)
    
    data = (map_value(joyX, -1, 1, 1024, 0), map_value(joyY, -1, 1, 0, 1024), map_value(twist, -1, 1, 256, 0), map_value(slider, -1, 1, 0, 512))
